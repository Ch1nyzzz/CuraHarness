...
from curaharness.locomo import load_locomo_examples, prepare_locomo, select_split
from curaharness.scaffolds.base import ScaffoldConfig
from curaharness.scaffolds.mem0_scaffold import (
...
def _persistent_mem0_config(sample: Any, out_dir: Path, extra: dict[str, Any]) -> dict[str, Any]:
    collection = str(extra.get("collection_name") or _safe_collection(f"curaharness_{sample.sample_id}"))

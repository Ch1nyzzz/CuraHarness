...
from curaharness.scaffolds.bm25_scaffold import SimpleBM25Okapi
from curaharness.utils.text import estimate_tokens, tokenize
...
def _compile_memory_metadata(
    *,
    ...
    lines = [
        "<memory_metadata>",
        f"- AGENT_ID: curaharness-{example.sample_id}",

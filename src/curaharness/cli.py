...
from curaharness.benchmark_tasks import TASK_CHOICES, normalize_task_name, task_spec
from curaharness.baseline import (
    DEFAULT_BASELINE_REPEATS,
    DEFAULT_BASELINE_SPLITS,
    run_baseline_suite,
)
from curaharness.evaluation import run_initial_frontier
from curaharness.locomo import prepare_locomo
from curaharness.locomo_optimizer import LocomoOptimizer, LocomoOptimizerConfig
from curaharness.longmemeval import (
...
from curaharness.longmemeval_optimizer import (
    LongMemEvalOptimizer,
    LongMemEvalOptimizerConfig,
)
from curaharness.model import DEFAULT_BASE_URL, DEFAULT_MODEL
from curaharness.claude_runner import DEFAULT_CODEX_MODEL
from curaharness.swebench import DEFAULT_MINI_SWE_AGENT_SOURCE_PATH
from curaharness.swebench_optimizer import SwebenchOptimizer, SwebenchOptimizerConfig
from curaharness.scaffolds import (
...
def main() -> int:
    parser = argparse.ArgumentParser(prog="curaharness")

...
class BenchmarkWorkspaceSpec:
    ...
    @property
    def allowed_curaharness_modules(self) -> tuple[str, ...]:
        """Top-level curaharness modules candidates may import from this snapshot."""
...
def copy_benchmark_project_source(
    *,
    ...
    source_pkg = project_root / "src" / "curaharness"
    copied: list[str] = []

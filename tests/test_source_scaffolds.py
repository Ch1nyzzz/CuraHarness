...
from curaharness.scaffolds.mem0_scaffold import Mem0SourceScaffold, _mem0_build_fingerprint
from curaharness.schemas import ConversationTurn, LocomoExample
...
def test_mem0_source_scaffold_uses_upstream_api(monkeypatch):
    ...
    monkeypatch.setattr("curaharness.scaffolds.mem0_scaffold.load_mem0_memory_class", lambda: FakeMemory)
...
def test_mem0_source_scaffold_can_load_source_snapshot(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("curaharness.scaffolds.mem0_scaffold.load_mem0_memory_class", fake_load_mem0_memory_class)

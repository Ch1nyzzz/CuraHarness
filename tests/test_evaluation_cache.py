...
from curaharness.schemas import ConversationTurn, LocomoExample, RetrievalHit
from curaharness.model import LocalModelClient
from curaharness.scaffolds.base import RetrievalMemoryScaffold, ScaffoldConfig, ScaffoldRun
